...
export default function ContactSection() {
	return (
		<section className="py-20 px-4 bg-[#040427]" style={{ borderTopLeftRadius: '50% 30px', borderTopRightRadius: '50% 30px' }}>
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:usamaaslam739@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/usama739"
							target="_blank"
							rel="noopener noreferrer"
						...
						<a
							href="https://www.linkedin.com/in/muhammad-usama-aslam-943789248"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
						...
						<a
							href="https://x.com/UsamaAs13203401"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
